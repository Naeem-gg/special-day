    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            {senderName ? <strong>{senderName}</strong> : 'Someone'} has gifted you a{' '}
            <strong>{planName}</strong> Wedding Invitation plan on DNvites.
          </Text>

          <Text style={text}>
            Now you can create a stunning, animated digital wedding invitation and share it with all
            your guests effortlessly.
          </Text>
