  ...
  return (
    <>
      ...
      <div className={isThumbnail ? "min-h-full" : "min-h-screen"} style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
        ...
        {/* ── OUR STORY ───────────────────────────── */}
        {ourStory && (
          <section className="py-32 px-6 relative overflow-hidden" style={{ background: "#050505" }}>
            <StarField />
            <div className="max-w-2xl mx-auto relative z-10 text-center">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <Star className="w-6 h-6 mx-auto mb-6 text-[#C9A84C]" />
                <h2 className="text-3xl md:text-4xl font-light tracking-[0.2em] uppercase mb-10" style={{ color: "#C9A84C" }}>Our Story</h2>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <div className="flex flex-col items-center gap-8">
                ...
                <div className="space-y-4">
                  <p className="font-sans text-[10px] uppercase tracking-[0.5em] text-[#888]">The Rendezvous</p>
                  <h3 className="text-3xl md:text-4xl font-light text-[#C9A84C]">{venue}</h3>
                  <p className="text-white/40 max-w-sm mx-auto font-sans text-sm">Join us at this beautiful location for our special day.</p>
                </div>
                <a
                  href={mapUrl}
                  target="_blank"
