...
export default function AzureOceanTemplate({
  brideName,
  groomName,
  date,
  venue,
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse 80% 40% at 50% 0%, rgba(78,205,196,0.15) 0%, transparent 70%)',
            }}
          />
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <motion.p
              ...
              className="font-sans text-xs uppercase mb-10 text-teal-300"
            >
            ...
            <motion.p
              ...
              className="text-2xl font-light italic my-3 text-teal-300"
            >
              &amp;
            </motion.p>
            ...
            <motion.p
              ...
              className="font-sans text-base mt-8 text-teal-200 tracking-widest"
            >
              {fmt}
            </motion.p>
            <motion.p
              ...
              className="font-sans text-sm mt-2 text-blue-300"
            >
              {venue}
            </motion.p>
          </div>
        ...
        <section className="py-24 px-4" style={{ background: 'white' }}>
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p className="font-sans text-xs uppercase tracking-[0.4em] mb-3 text-teal-500">
                What's Planned
              </p>
              <h2 className="text-4xl font-light" style={{ color: '#0A3F6B' }}>
                Shore-side Events
              </h2>
              <div
            ...
            <div className="space-y-6">
              {events.map((ev, i) => (
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #F0FAFC, #EBF8FF)',
                ...
                >
                  ...
                  />
                  <p className="font-sans text-xs uppercase tracking-widest mb-2 text-teal-500">
                    Event {i + 1}
                  </p>
                  <h3 className="text-2xl font-light mb-2" style={{ color: '#0A3F6B' }}>
                    {ev.name}
                  </h3>
                  {ev.description && (
                    <p className="font-sans text-sm mb-4 text-teal-700">{ev.description}</p>
                  )}
        ...
        <section
          ...
          style={{ background: 'linear-gradient(180deg, #0A3F6B, #0A1628)' }}
        >
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
