...
function Firefly({ style }: { style: React.CSSProperties }) {
  return (
    <div
      ...
      style={{
        ...style,
        boxShadow: '0 0 6px 2px rgba(184,115,51,0.6)',
  ...
  return (
    <div className="absolute top-0 right-0 w-48 h-48 md:w-72 md:h-72 pointer-events-none opacity-15">
      <svg viewBox="0 0 200 200" fill="none">
        <motion.path
          d="M180 20 Q140 60, 100 100 Q70 130, 40 180"
          stroke="#B87333"
          strokeWidth="2.5"
          strokeLinecap="round"
...
export default function EmeraldForestTemplate({
  brideName,
  groomName,
  date,
  venue,
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <motion.p
              ...
              className="font-sans text-xs uppercase tracking-[0.5em] mb-10"
              style={{ color: '#B87333' }}
            >
              A Forest Wedding
            </motion.p>
            ...
            <motion.h1
              ...
              style={{ color: '#F0EAD6', fontSize: 'clamp(3rem, 11vw, 8rem)' }}
            >
              {brideName}
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-3xl font-light italic my-3"
              style={{ color: '#B87333' }}
            >
              &amp;
            </motion.p>
            ...
            <motion.p
              ...
              className="font-sans text-base tracking-widest mt-8"
              style={{ color: '#A8C8A0' }}
            >
              {fmt}
            </motion.p>
        ...
        <section className="py-24 px-4" style={{ background: 'white' }}>
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl font-light" style={{ color: '#1A3C34' }}>
                The Events
              </h2>
            </motion.div>
                ...
                {gallery.map((img, i) => (
                  ...
                  >
                    <img
                      src={img.url}
                      alt=""
                      className="w-full object-cover transition-transform duration-700 hover:scale-105 sepia-[0.2]"
                    />
                  </motion.div>
                ))}
              </div>
        ...
        <section
          ...
          style={{ background: 'linear-gradient(160deg, #0D2218, #1A3C34)' }}
        >
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
