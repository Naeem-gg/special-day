    ...
    const draw = () => {
      ...
      stars.forEach((s) => {
        ...
        ctx.fillStyle = s.color
          .replace(')', `,${s.brightness})`)
          .replace('rgb', 'rgba')
          .replace('white', `rgba(255,255,255,${s.brightness})`)
        ctx.fill()
      })
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div
              style={{
                ...
                width: '40%',
                height: '40%',
                background: 'radial-gradient(ellipse, rgba(108,59,166,0.12) 0%, transparent 70%)',
                filter: 'blur(40px)',
              }}
            />
            <div
              style={{
                ...
                width: '30%',
                height: '30%',
                background: 'radial-gradient(ellipse, rgba(0,200,200,0.06) 0%, transparent 70%)',
                filter: 'blur(30px)',
              }}
            />
          </div>
          ...
          <div className="relative z-10 max-w-4xl">
            <motion.div
              ...
              style={{
                background: 'radial-gradient(circle, rgba(255,215,0,0.15), rgba(108,59,166,0.1))',
            ...
            <motion.p
              ...
              className="font-sans text-[10px] uppercase mb-10"
              style={{ color: '#B8A0FF' }}
            >
            ...
            <motion.div
              ...
              style={{
                width: 120,
                background: 'linear-gradient(to right, transparent, #FFD700, #B8A0FF, transparent)',
              }}
            />
            ...
            <motion.div
              ...
              style={{
                width: 120,
                background: 'linear-gradient(to right, transparent, #B8A0FF, #FFD700, transparent)',
              }}
            />
            ...
            <motion.p
              ...
              className="font-sans text-base tracking-widest mt-10"
              style={{ color: '#C0B0FF' }}
            >
              {fmt}
            </motion.p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p
                ...
                style={{ color: '#B8A0FF' }}
              >
                Constellations of the Evening
              </p>
              <h2 className="text-4xl font-light" style={{ color: '#E0D4FF' }}>
                The Events
              </h2>
              <div
                ...
                style={{
                  width: 60,
                  background:
                    'linear-gradient(to right, transparent, #FFD700, #B8A0FF, transparent)',
                }}
              />
            </motion.div>
            <div className="space-y-4">
              {events.map((ev, i) => (
                <motion.div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, rgba(108,59,166,0.15), rgba(10,14,42,0.8))',
        ...
        {gallery.length > 0 && (
          <section className="py-24 px-4" style={{ background: '#0A0E2A' }}>
            <div className="max-w-5xl mx-auto">
              ...
              >
                <h2 className="text-4xl font-light" style={{ color: '#FFD700' }}>
                  Stardust Memories
                </h2>
              </motion.div>
                ...
                {gallery.map((img, i) => (
                  <motion.div
                    ...
                    style={{
                      breakInside: 'avoid',
                      border: '1px solid rgba(184,160,255,0.2)',
                      boxShadow: '0 0 20px rgba(108,59,166,0.2)',
                    }}
                  >
                    <img
                      src={img.url}
                      alt=""
                      className="w-full object-cover transition-transform duration-700 hover:scale-105 brightness-75 hover:brightness-90 saturate-[0.8]"
                    />
                  </motion.div>
                ))}
              </div>
        ...
        <section
          ...
          style={{ background: 'linear-gradient(180deg, #060818, #020412)' }}
        >
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl font-light mb-2" style={{ color: '#E0D4FF' }}>
              Come, Celebrate Under the Stars
            </h2>
