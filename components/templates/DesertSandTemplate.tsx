...
export default function DesertSandTemplate({
  ...
  return (
    ...
    >
      ...
      {/* --- HERO --- */}
      <section
        className={`relative flex flex-col items-center justify-center text-center px-6 ${isThumbnail ? 'min-h-[812px]' : 'min-h-screen'} bg-linear-to-tr from-[#FDF5E6] via-[#F5E6D3] to-[#FDF5E6]`}
      >
        <motion.div
        ...
        >
          ...
          <h2 className="text-sm font-sans uppercase tracking-[0.6em] mb-12 text-[#D2691E]">
            Wild &amp; Free
          </h2>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm font-sans uppercase tracking-[0.4em] text-[#D2691E]/80">
              {venue}
            </p>
          </div>
        </motion.div>
      ...
      <section className="py-20 text-center bg-[#F5E6D3]/30">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-sm font-sans uppercase tracking-[0.5em] mb-10 text-[#D2691E]">
      ...
      {ourStory && (
        <section className="py-40 px-6 bg-[#634133] text-[#FDF5E6]">
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <p className="text-2xl leading-relaxed italic opacity-80">"{ourStory}"</p>
      ...
      <section className="py-40 px-6">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-sm font-sans uppercase tracking-[0.6em] text-center mb-24 text-[#D2691E]">
            Ceremony Schedule
          </h2>
          <div className="space-y-32">
            {events.map((ev, i) => (
              ...
              >
                <div className="text-6xl font-light opacity-5 absolute -top-12 left-1/2 -translate-x-1/2">
                  {ev.time}
                </div>
