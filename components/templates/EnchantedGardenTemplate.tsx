    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 className="text-sm font-sans uppercase tracking-[0.5em] mb-12 text-[#D4AF37]/60 italic font-bold">
            In the Heart of the Forest
          </h2>

          <h1
            className="text-7xl md:text-9xl font-normal tracking-wide mb-6 text-[#EAD8A0]"
          ...
          <h1
            className="text-7xl md:text-9xl font-normal tracking-wide mb-16 text-[#EAD8A0]"
            style={{ fontFamily: 'var(--font-playfair)' }}
          >
            {groomName}
          </h1>
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg tracking-[0.2em] font-sans uppercase font-bold text-green-500/60">
              {venue}
            </p>
          </div>
        </motion.div>
      ...
      <section className="py-20 text-center relative z-10 bg-black/20">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-xs font-sans uppercase tracking-[0.5em] mb-10 text-[#D4AF37]/60 italic font-bold">
            The Magic Begins In
          </p>
          <PremiumCountdown
            targetDate={date}
      ...
      <section className="py-40 px-6 relative">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-normal text-center mb-32 italic text-[#EAD8A0]">
            Forest Gathering
          </h2>
            ...
            {events.map((ev, i) => (
              ...
              >
                <div className="flex justify-between items-center mb-10">
                  ...
                  <span className="text-xs font-sans font-bold uppercase tracking-[0.4em] text-green-500">
                    {ev.time}
                  </span>
                </div>
              ...
              {gallery.map((img, i) => (
                ...
                >
                  <img
                    src={img.url}
                    alt=""
                    className="w-full h-[500px] object-cover saturate-150 brightness-75 hover:brightness-100 transition-all duration-1000"
                  />
                </motion.div>
              ))}
            </div>
