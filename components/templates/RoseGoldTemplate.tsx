      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            {[500, 700, 900].map((s) => (
              <div
                key={s}
                className="absolute rounded-full border border-rose-200/20"
          ...
          <div className="relative z-10 max-w-4xl">
            <motion.p
              ...
              className="font-sans text-xs uppercase mb-10"
              style={{ color: '#B76E79' }}
            >
            ...
            <motion.h1
              ...
              className="gold-shimmer font-light leading-none"
              style={{ fontSize: isThumbnail ? '3.5rem' : 'clamp(3.5rem, 13vw, 9rem)' }}
            >
              {brideName}
            </motion.h1>
            ...
            <motion.div
              ...
              style={{
                width: 120,
                background: 'linear-gradient(to right, transparent, #B76E79, #D4AF37, transparent)',
              }}
            />
            ...
            <motion.p
              ...
              className="text-3xl font-light italic my-4"
              style={{ color: '#B76E79' }}
            >
              &amp;
            </motion.p>
            ...
            <motion.p
              ...
              className="mt-8 font-sans text-lg tracking-widest"
              style={{ color: '#9B6A5A' }}
            >
              {fmt}
            </motion.p>
        ...
        {ourStory && (
          ...
          >
            <div className="max-w-2xl mx-auto relative">
              ...
              <div className="absolute -top-10 left-1/2 -translate-x-1/2 opacity-5 text-8xl font-serif">
                "
              </div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                ...
                <h2 className="text-4xl font-light mb-8 italic" style={{ color: '#2C1810' }}>
                  How We Met
                </h2>
                <div
        ...
        {mapUrl && (
          <section
            ...
            style={{ background: 'linear-gradient(to bottom, #FFF8F0, white)' }}
          >
            <motion.div
            ...
            >
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <h3 className="text-3xl font-light" style={{ color: '#2C1810' }}>
                    Location & Directions
                  </h3>
        ...
        <section className="py-24 px-4" style={{ background: 'white' }}>
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h2 className="text-4xl font-light" style={{ color: '#2C1810' }}>
                The Events
              </h2>
              <div
            ...
            <div className="space-y-6">
              {events.map((ev, i) => (
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #FFF8F2, #FFF0F0)',
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    {ev.description && (
                      <p className="font-sans text-sm mb-4" style={{ color: '#9B6A5A' }}>
                        {ev.description}
                      </p>
                    )}
                    <div
        ...
        <section className="py-20 text-center" style={{ background: 'white' }}>
          ...
          >
            ...
            <h2 className="text-3xl font-light mb-2" style={{ color: '#2C1810' }}>
              We Can't Wait to Celebrate With You
            </h2>
            <p className="font-sans text-sm mb-10" style={{ color: '#B89090' }}>
              {venue}
            </p>
