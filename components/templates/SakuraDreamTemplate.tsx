...
export default function SakuraDreamTemplate({
  brideName,
  groomName,
  date,
  venue,
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ fontFamily: "'Playfair Display', Georgia, serif", background: '#FFFAFD' }}
      >
        {/* ── HERO ─────────────────────────────────── */}
        <section
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            ...
            >
              <path
                d="M100 150 Q300 50, 500 150 Q300 250, 100 150Z"
                stroke="#D4B4FD"
                strokeWidth="2"
                fill="none"
          ...
          <div className="relative z-10 max-w-3xl">
            <motion.p
              ...
              className={`font-sans text-[10px] uppercase ${isThumbnail ? 'mb-6' : 'mb-12'}`}
              style={{ color: '#C4A0C8' }}
            >
              花嫁と花婿 · Bride &amp; Groom
            </motion.p>
            ...
            <motion.div
              ...
              style={{
                background:
                  'radial-gradient(circle, rgba(212,180,253,0.15) 0%, rgba(255,183,197,0.08) 100%)',
                border: '1px solid rgba(212,180,253,0.3)',
              }}
            >
              <motion.h1
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className={`font-light leading-snug text-center ${isThumbnail ? 'text-lg' : 'text-2xl md:text-3xl'}`}
                style={{ color: '#4A2060' }}
              >
                {brideName}
                <br />
                <span
                  className={`${isThumbnail ? 'text-xs' : 'text-base'} font-light italic`}
                  style={{ color: '#D4B4FD' }}
                >
                  &amp;
                </span>
            ...
            >
              <h2
                className={`font-light tracking-tight leading-tight ${isThumbnail ? 'text-2xl' : 'text-5xl md:text-8xl'}`}
                style={{ color: '#4A2060' }}
              >
                {brideName}
                <span
                  className={`${isThumbnail ? 'text-lg' : 'text-3xl'} font-light italic mx-4`}
                  style={{ color: '#FFB7C5' }}
                >
                  &amp;
                </span>
            ...
            <motion.div
              ...
              className={`mx-auto h-px ${isThumbnail ? 'my-4' : 'my-8'}`}
              style={{
                width: 100,
                background: 'linear-gradient(to right, transparent, #D4B4FD, transparent)',
              }}
            />
            ...
            <motion.p
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 3 }}
              className="font-sans text-base tracking-[0.3em]"
              style={{ color: '#C4A0C8' }}
            >
              {fmt}
            </motion.p>
        ...
        <section className="py-20 text-center" style={{ background: 'white' }}>
          ...
          >
            <p
              className="font-sans text-[10px] uppercase tracking-[0.5em] mb-10"
              style={{ color: '#D4B4FD' }}
            >
        ...
        {ourStory && (
          <section className="py-24 px-6 text-center" style={{ background: '#FFF0F8' }}>
            <div className="max-w-2xl mx-auto relative">
              ...
              <div className="absolute -top-12 left-1/2 -translate-x-1/2 text-4xl opacity-40">
                🌸
              </div>
              <motion.div
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <p
                  className="font-sans text-[10px] uppercase tracking-[0.5em] mb-6"
                  style={{ color: '#C4A0C8' }}
                >
                  私たちの物語 · Our Story
                </p>
                <h2 className="text-4xl font-light mb-8 italic" style={{ color: '#4A2060' }}>
        ...
        <section className="py-24 px-4" style={{ background: '#FAF5FF' }}>
          <div className="max-w-2xl mx-auto">
            ...
            >
              <p
                className="font-sans text-[10px] uppercase tracking-[0.5em] mb-3"
                style={{ color: '#D4B4FD' }}
              >
                Our Ceremony
              </p>
              <h2 className="text-4xl font-light" style={{ color: '#4A2060' }}>
                Events &amp; Schedule
              </h2>
            </motion.div>
            <div className="space-y-8">
              {events.map((ev, i) => (
                ...
                >
                  ...
                  {ev.description && (
                    <p className="font-sans text-sm mb-3" style={{ color: '#9B7BB0' }}>
                      {ev.description}
                    </p>
                  )}
                  <div
        ...
        <section
          ...
          style={{ background: 'linear-gradient(160deg, #FFF0F8, #FAF0FF)' }}
        >
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h2 className="text-3xl font-light mb-2" style={{ color: '#4A2060' }}>
              We Can't Wait to See You
            </h2>
            <p className="font-sans text-sm mb-10" style={{ color: '#C4A0C8' }}>
              {venue}
            </p>
