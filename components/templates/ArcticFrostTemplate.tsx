...
export default function ArcticFrostTemplate({
  ...
  return (
    ...
    >
      ...
      {/* --- HERO --- */}
      <section
        className={`relative flex flex-col items-center justify-center text-center px-6 ${isThumbnail ? 'min-h-[812px]' : 'min-h-screen'} bg-linear-to-b from-blue-100/50 to-[#F0F8FF]`}
      >
        <motion.div
        ...
        >
          ...
          <h2 className="text-xs uppercase tracking-[0.6em] mb-12 text-blue-500 font-bold">
            The Winter Celebration
          </h2>
          <h1
            className="text-6xl md:text-9xl font-black mb-6 text-transparent bg-clip-text bg-linear-to-b from-[#1A2A3A] to-[#4682B4]"
          ...
          <h1
            className="text-6xl md:text-9xl font-black mb-16 text-transparent bg-clip-text bg-linear-to-b from-[#1A2A3A] to-[#4682B4]"
            style={{ fontFamily: 'var(--font-cinzel)' }}
          >
            {groomName}
          </h1>
          <p className="text-xl md:text-2xl font-light mb-2 tracking-widest text-blue-900/60 uppercase font-bold">
            {fmt}
          </p>
          <p className="text-sm font-medium tracking-[0.2em] text-blue-400 uppercase italic">
            {venue}
          </p>
        </motion.div>
      </section>
      ...
      {ourStory && (
        <section className="py-40 px-6 relative bg-white/20 backdrop-blur-sm border-y border-white/50">
          <div className="max-w-3xl mx-auto text-center">
            <h2
              className="text-4xl font-black mb-16 text-[#1A2A3A]"
              style={{ fontFamily: 'var(--font-cinzel)' }}
            >
              A Frozen Tale
            </h2>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-1 px-4">
          {events.map((ev, i) => (
            ...
            >
              ...
              <h3 className="text-2xl font-black" style={{ fontFamily: 'var(--font-cinzel)' }}>
                {ev.name}
              </h3>
      ...
      <section className="py-40 px-6 text-center">
        <div className="max-w-xl mx-auto p-20 bg-white/60 rounded-[40px] border border-white shadow-inner">
          ...
          <h2
            className="text-4xl font-black mb-10 text-[#1A2A3A]"
            style={{ fontFamily: 'var(--font-cinzel)' }}
          >
