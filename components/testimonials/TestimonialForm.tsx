...
export function TestimonialForm({ 
  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-xl border border-rose-100 max-w-xl mx-auto">
      <div className="text-center mb-8">
        <h3 className="text-2xl font-bold text-gray-900 mb-2">Share Your Experience</h3>
        <p className="text-gray-500">
          Your feedback helps us grow. <br />
          <span className="text-xs text-rose-500 font-medium">Verified purchase required — please use your order email.</span>
        </p>
      </div>
