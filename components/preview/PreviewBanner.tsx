  ...
  return (
    <>
      ...
      <div
        ...
        style={{ background: isUrgent ? '#7F1D1D' : '#1A0A12' }}
      >
        {/* Progress bar */}
        <div className="h-0.5" style={{ background: 'rgba(255,255,255,0.1)' }}>
          <motion.div
            className="h-full"
            style={{ background: isUrgent ? '#EF4444' : '#D4AF37', width: `${pct}%` }}
        ...
        <div className="flex items-center justify-between px-4 py-2.5 max-w-7xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="text-[10px] font-sans font-bold uppercase tracking-widest hidden sm:block">
                Back
              </span>
            </button>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span
                className={`font-mono text-sm font-bold ${isUrgent ? 'text-red-300' : 'text-amber-300'}`}
              >
                {String(mins).padStart(2, '0')}:{String(secs).padStart(2, '0')}
              </span>
              <span className="text-white/50 text-[10px] font-sans uppercase tracking-tight">
                left
              </span>
            </div>
          </div>
          ...
          <div className="text-center hidden lg:block">
            <p className="text-white/60 text-[10px] font-sans uppercase tracking-widest">
              Preview Mode • {template.replace(/-/g, ' ')}
            </p>
          </div>
      ...
      <AnimatePresence>
        {expired && (
          ...
          >
            <motion.div
              className="max-w-md w-full rounded-[2rem] p-10 text-center"
              style={{
                background: 'linear-gradient(135deg, #1A0A12, #2A1020)',
            ...
            >
              ...
              <h2 className="text-3xl font-serif font-light text-white mb-3">
                Your Preview Has Ended
              </h2>
              <p className="text-white/60 font-sans text-sm mb-8 leading-relaxed">
                Loved what you saw? Purchase this template to unlock your full, shareable invitation
                with RSVP tracking, gallery, and more.
              </p>
