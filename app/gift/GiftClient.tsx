          ...
          {step === 'details' ? (
            ...
            >
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-slate-500 mt-4 text-lg">
                    Purchase a gift code for a friend or family member. They can use it to create
                    their dream invitation for free!
                  </p>
                </div>
                  ...
                  {GIFT_TIERS.map((tier) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <h3
                            className={`font-bold text-xl ${selectedTier.id === tier.id ? tier.text : 'text-slate-900'}`}
                          >
                            {tier.name}
                          </h3>
                      ...
                      <ul className="space-y-2">
                        {tier.features.map((f, i) => (
                          <li key={i} className="flex items-center gap-2 text-sm text-slate-600">
                            <div
                              className={`w-1.5 h-1.5 rounded-full ${selectedTier.id === tier.id ? 'bg-[#F43F8F]' : 'bg-slate-300'}`}
                            />
                            {f}
                          </li>
                        ))}
              ...
              <Card className="border-0 shadow-2xl rounded-[2.5rem] overflow-hidden sticky top-24">
                <div
                  className={`h-32 bg-linear-to-br ${selectedTier.color} relative overflow-hidden`}
                >
            ...
            >
              <Card className="border-0 shadow-2xl rounded-[3rem] overflow-hidden text-center p-12">
                ...
                <div className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-8 mb-8 relative group">
                  ...
                  <p className="text-4xl font-bold text-slate-900 font-mono tracking-wider">
                    {generatedCode}
                  </p>
                  <Button
                    variant="ghost"
