  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-(--dn-gold) opacity-[0.03] rounded-full blur-3xl animate-glow-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="max-w-md w-full text-center z-10 animate-slide-up">
        <div className="mb-8">
          <div className="glass p-10 rounded-[2.5rem] border-destructive/10 relative">
            ...
            <h1 className="text-4xl font-serif font-bold text-(--dn-dark) mt-4 mb-2">Oops! Something went wrong</h1>
            <div className="w-12 h-1 bg-destructive/20 mx-auto mb-6 rounded-full" />

            <p className="text-muted-foreground leading-relaxed mb-6">
              We encountered an unexpected glitch while preparing your celebration. Our team has been notified and is working to fix it.
            </p>
        ...
        <p className="mt-12 text-sm text-muted-foreground font-medium">
          Still having trouble? <a href="mailto:support@dnvites.com" className="text-(--dn-rose) hover:underline">Contact Support</a>
        </p>
      </div>
    </div>
  )
