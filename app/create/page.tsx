...
import { HeartIcon, UserPlusIcon, GlobeIcon } from "lucide-react"
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <DatePicker date={formData.eventDate} onSelect={handleDateChange} />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      >
                        <div className={"flex flex-col items-center text-center space-y-2 p-4"}>
                          <p className="text-sm text-gray-500 ">{displayText && "Coming Soon..."}</p>
