...
import { MessageSquare, AlertTriangle, Lightbulb, FileText, Send, CheckCircle2, ChevronDown, ChevronUp, Clock, Shield } from "lucide-react";
...
export default function FeedbackPage() {
  ...
  const [threads, setThreads] = useState<FeedbackItem[]>([]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      // Don't reset selectedType yet so we can show the right message
